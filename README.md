...
└── app_fastapi/     # FastAPI app, composition root (app_fastapi module)
```
...
```bash
uv run pytest packages/core/tests packages/repository/tests packages/clients/tests packages/app_fastapi/tests -v
```
